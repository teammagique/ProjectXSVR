            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xl-6 ">
                    <div class="dashboard-box margin-top-0">
                        ...
                        <!-- Headline -->
                        <div class="headline">
                            <h3><i class="icon-feather-folder-plus"></i> Edit your profile</h3>
                        </div>
                        ...
                        <div class="content with-padding padding-bottom-10">
                            ...
                            <form method="POST" action="{{route('profile.edit')}}" >
                                ...
                                <input type="text" name='title' value="{{$profile->title}}" class="with-border @error('title') with-border-danger @enderror" placeholder="eg software developer">
                                    @error('title')
                                ...
                                <textarea cols="30" rows="5" name="bio" Value="{{$profile->bio}}" class="with-border value= @error('bio') with-border-danger @enderror"></textarea>
                                    @error('bio')
                                    <div class="notification error ">
                                    <p>{{$message}}</p>
                                        <a class="close" href="#"></a>
