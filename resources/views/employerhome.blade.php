...
<header id="header-container" class="fullwidth">
	...
	<div id="header">
		<div class="container">
			...
			<div class="left-side">
				...
				<nav id="navigation">
					<ul id="responsive">
                        ...
                        <li><a href="" class="c">find a Professional</a>
                        </li>
            ...
            @guest()
            <div class="header-widget">
            <a href="{{route('login')}}" class="popup-with-zoom-anim log-in-button"><i class="icon-feather-log-in"></i> <span>Log In </span></a>
            <a href="{{route('register')}}" class="popup-with-zoom-anim log-in-button"><i class="icon-feather-log-in"></i> <span>Register </span></a>
