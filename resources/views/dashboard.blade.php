				...
				<div class="dashboard-nav">
					<div class="dashboard-nav-inner">
						...
						<ul data-submenu-title="Start">
							...
							<li><a href=""><i class="icon-material-outline-star-border"></i> Notifications</a></li>
                            <li><a href=""><i class="icon-material-outline-rate-review"></i> Reviews</a></li>
                            <li><a href=""><i class="icon-material-outline-rate-review"></i> </a></li>
						...
						<ul data-submenu-title="Account">
                            ...
                            <li><button type="submit" form="logout-form" class="button dark ripple-effect button-sliding-icon"><i class="icon-feather-check"></i> Logout</button></li>
